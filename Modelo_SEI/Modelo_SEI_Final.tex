...
%\newcommand{\metodos}{ 
%As fontes de dados, a população estudada, amostragem, critérios de seleção, procedimentos analíticos, dentre outros, devem ser descritos de forma compreensiva e completa.  
%} 
...
% \large{Nome_dois}  \thanks{email_dois},  
% \large{Nome_três}  \thanks{email_três} 
...
\begin{itemize}
	...
	\item[Seção Quinárias]:  Apenas a primeira letra inicial da primeira palavra em maiúscula, sem negrito e, em itálico. \\ 
...
\begin{verbatim}
\begin{itemize}  
\item[Descrição]: Primeiro item;  
\item[Descrição2]: Segundo item; 
\item[Último]: Último.
\end{itemize} 
\label{lista01} 
