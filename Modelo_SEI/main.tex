...
% Altere o logotipo e o nome apenas se o trabalho não for apresentado para SEI na oitava edição 
\newcommand{\eventpicture}{figs/seii}  
\newcommand{\eventedition}{\Rnth{8} SEI} 
\newcommand{\eventname}{$8^\circ$ Seminário de Extensão e Inovação}  
...
\newcommand{\words}{KeyOne. KeyTwo. KeyT.} 
